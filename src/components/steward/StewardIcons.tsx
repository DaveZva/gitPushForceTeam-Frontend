export const StewardIcons = {
    ...
    Bell: ({ active }: { active?: boolean }) => (
        <svg xmlns="http://www.w3.org/2000/svg" fill={active ? "currentColor" : "none"} viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={`w-5 h-5 ${active ? 'animate-bounce text-white' : ''}`}>

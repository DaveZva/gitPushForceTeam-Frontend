    ...
    return (
        <div className="min-h-screen bg-slate-900 text-white p-6 font-sans">
            ...
            <header className="flex justify-between items-center mb-10 border-b border-slate-700 pb-4">
                <div>
                    <h1 className="text-4xl font-black uppercase tracking-tighter text-indigo-400">
                        Vyvolávání koček / <span className="text-white">Calling System</span>
                    </h1>
                    <p className="text-slate-400 text-lg">Mezinárodní výstava koček Ostrava 2026</p>
                </div>
                <div className="text-right">
                    <div className="text-3xl font-mono font-bold">14:45</div>
                    <div className="text-sm text-indigo-300 uppercase tracking-widest">Live Updates</div>
                </div>
            </header>
                ...
                {MOCK_DATA.map((item) => (
                    ...
                    >
                        ...
                        <div className={`absolute top-0 right-0 px-6 py-2 rounded-bl-2xl font-bold uppercase text-xs tracking-widest ${
                            ...
                            {item.status === 'JUDGING' ? 'Nyní posuzujeme' :
                                item.status === 'PREPARING' ? 'Připravit se' : 'Čeká se'}
                        </div>

                        <div className="p-8">
                            <div className="flex items-start justify-between mb-4">
                                <div>
                                    <span className="text-slate-400 uppercase text-sm font-bold tracking-widest">Kruh / Ring</span>
                                    <div className="text-6xl font-black text-indigo-400 leading-none">{item.ring}</div>
                                </div>
                                <div className="text-right">
                                    <span className="text-slate-400 uppercase text-sm font-bold tracking-widest">Posuzovatel</span>
                            ...
                            <div className="flex items-center justify-center py-6 bg-slate-900/50 rounded-2xl my-4">
                                <div className="text-center">
                                    <span className="text-slate-500 uppercase text-xs font-bold tracking-widest block mb-1">Číslo kočky / Cat No.</span>
                            ...
                            <div className="flex justify-between items-end mt-4">
                                <div>
                                    <span className="text-slate-400 uppercase text-xs font-bold tracking-widest block">Plemeno / Breed</span>
            ...
            <footer className="mt-12 text-center text-slate-500 text-sm border-t border-slate-800 pt-6">
                Pro aktuální pořadí sledujte své mobilní zařízení nebo tištěný katalog.
                <br />
                <span className="text-indigo-500 font-semibold italic">CatShow IS – Powering Cat Exhibitions</span>
            </footer>
        </div>
    );
};

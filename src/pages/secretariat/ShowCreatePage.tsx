    ...
    return (
        <FormProvider {...methods}>
            <div className="max-w-4xl mx-auto p-8 bg-gray-50">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 bg-white p-8 rounded-lg shadow-xl">
                    ...
                    <fieldset className="space-y-4">
                        <legend className="text-xl font-semibold text-[#027BFF] border-b pb-2 mb-4">Základní informace</legend>
                        ...
                        <div className="flex flex-col">
                            <label htmlFor="description" className="mb-1 font-semibold text-gray-700">
                                {t('exhibitionCreate.description', 'Popis')}
                            </label>
            ...
            {errors.description.message}
                    ...
                    <fieldset className="space-y-4">
                        <legend className="text-xl font-semibold text-[#027BFF] border-b pb-2 mb-4">Místo konání</legend>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {/* Sekce 3: Termíny */}
                    <fieldset className="space-y-4">
                        <legend className="text-xl font-semibold text-[#027BFF] border-b pb-2 mb-4">Termíny</legend>
                    ...
                    {/* Sekce 4: Organizátor */}
                    <fieldset className="space-y-4">
                        <legend className="text-xl font-semibold text-[#027BFF] border-b pb-2 mb-4">Organizátor</legend>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">

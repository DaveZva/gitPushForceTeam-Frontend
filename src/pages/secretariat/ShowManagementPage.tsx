    ...
    return (
        <div className="container max-w-7xl mx-auto p-4 sm:p-8">
            <header className="flex justify-between items-center mb-8">
                ...
                <Link to="/secretariat/new/show" className="px-6 py-3 rounded-full font-semibold transition-all duration-300 bg-blue-600 text-white hover:bg-blue-700 shadow-lg">
                    {t('admin.shows.add')}
                </Link>
            </header>

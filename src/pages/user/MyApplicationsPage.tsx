                ...
                <td className="py-4 px-3 text-center flex items-center justify-center gap-2">
                    ...
                    {app.status === 'PLANNED' && (
                        <button
                            ...
                            className="px- py-1 text-sm font-semibold rounded-full transition-all duration-200 bg-green-600 text-white border-2 border-transparent hover:bg-transparent hover:border-green-600 hover:text-green-600 shadow-md"
                            title={t('actions.pay')}
                        >
                            {t('actions.pay')}
                        </button>

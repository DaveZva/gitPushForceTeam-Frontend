                ...
                {!isLoadingShows && upcomingShows.length > 0 && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {upcomingShows.map((show) => (
                            <div key={show.id} className="relative backdrop-blur-xl bg-white/40 border border-white/60
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-medium text-gray-800 mb-1">
                                        {t('table.date')}: {formatShowDateRange(show.startDate, show.endDate)}
                                    </p>

                                    <p className="text-sm text-gray-600">
                                        {t('location')}: {show.venueName}
                                    </p>
                                </div>
                            ...
                            <tr key={item.id} className="border-b">
                                ...
                                <td className="p-4">
                                    <div className="flex items-center justify-center gap-4">
                                        ...
                                        <a href="#" className="text-[#027BFF] font-medium">
                                            {t('common.pdf')}
                                        </a>
                                    </div>
                                </td>
